...
colstouse <-setdiff(names(train_data),c("starttime","start.station.id","end.station.id",
                                           ...
                                           "weekday","bikeid","birth.year","SNOW","SNWD","PRCP","DATE",
...
```{r}
validation_data <- read.csv("~/Downloads/Datasets/citybike.test10000Awithduration.csv")
```
...
```{r}
test_data<-read.csv("~/Downloads/Datasets/citybike.test20000.csv")
```
